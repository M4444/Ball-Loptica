...
public class LopticaIgra extends Application {
    ...
    private final Color[] boje = { Color.YELLOW, Color.WHITE, Color.GRAY, 
    ...
    private class MyTimer extends AnimationTimer
    {
        ...
        public void handle(long sada) // izrazeno u ns
        {
            ...
            if (!pauza)
            {
                ...
                if(!kraj) konacnoVremeTekst.setText( trenutnoVreme );
            }
            prethodni = sada;
            if (!pocetnoVremeSet)
            {
        ...
        private String vremeFormat(long vreme)
        {
            ...
            if (casovi != 0) formatVreme += casovi + "h ";
            if (minuti != 0) formatVreme += minuti + "m ";
    ...
    private void onMouseReleased(MouseEvent e)
    {
        ...
        granica.setX(x1); granica.setY(y1);
        granica.setWidth(x2-x1); granica.setHeight(y2-y1);
    }
